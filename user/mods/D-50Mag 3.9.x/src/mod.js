...
class ExtendedMags {
    ...
    displayCreditBanner() {
        ...
        this.Instance.logger.log(`[${this.modName}] Developers:           Evo`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] "All gas no brakes"`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] ------------------------------------------------------------------------`, LogTextColor_1.LogTextColor.GREEN);
    }
}
module.exports = { mod: new ExtendedMags() };
